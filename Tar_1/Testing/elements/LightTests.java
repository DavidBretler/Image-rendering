...
class LightsTests {
    ...
    public void sphereDirectional() {
        ...
        scene.addGeometries(
                new Sphere(new Color(java.awt.Color.BLUE),
                        new Material(0.5, 0.5, 100), 50, new Point3D(0, 0, 50)));
    ...
    public void multipleLightsTriangles() {
        ...
        scene.addLights(new SpotLight(new Color(0d, 250, 0d),
                new Point3D(10, 10, 130), new Vector(-2, 2, 1),
                1, 0.0001, 0.000005));
        ...
        scene.addLights(new DirectionalLight(new Color(100, 0d, 0d), new Vector(0, 1, 50)));


        ImageWriter imageWriter = new ImageWriter("multiple Lights Triangles", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    @Test
    public void trianglesSpotWithConcentration() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        ImageWriter imageWriter = new ImageWriter("trianglesSpotWithConcentration", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    /**
     * Produce a picture of a sphere lighted by a spot light with Concentration parameter to narrow the beam
     */
    @Test
    public void sphereSpotWithConcentration() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, 1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
                new Vector(1, -1, 2), 1, 0.00001, 0.00000001,3));

        ImageWriter imageWriter = new ImageWriter("sphereSpotWithConcentration", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
